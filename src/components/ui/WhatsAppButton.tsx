  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[90] flex flex-col items-end gap-2">
      {tooltip && (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setTooltip(false)} className="text-text-muted hover:text-text-primary cursor-pointer" aria-label="Dismiss">
              <X size={14} />
            </button>
          </div>
        </div>
      ...
      <a
        ...
        className="w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(37,211,102,0.3)]"
