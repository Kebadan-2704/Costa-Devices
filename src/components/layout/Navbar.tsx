        ...
        <nav className="pointer-events-auto w-full">
          ...
          <div className={`transition-all duration-500 border-b ${
            ...
            <div className="max-w-[1400px] mx-auto px-6 flex items-center justify-between">
              ...
              <Link href="/" className="flex items-center group relative shrink-0">
                <div className={`relative transition-all duration-500 ${
                  scrolled 
                    ...
                    : "h-14 w-[220px] md:h-16 md:w-[260px]"
                }`}>
                  <Image 
                    src="/logos/logo.png" 
              ...
              {/* Desktop: Nav Links + Actions inline */}
                ...
                <div className="flex items-center gap-1 mr-4">
                  {NAV_LINKS.map((link: any) => (
                    <div key={link.label} className="group relative flex items-center">
                      <Link
                        href={link.href}
                        className={`relative text-[15px] font-semibold transition-all duration-300 px-5 py-2.5 rounded-full
                          ${pathname === link.href 
