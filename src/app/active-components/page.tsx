            ...
            <div className="lg:col-span-5 z-10">
              <ScrollReveal>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="#capabilities" className="rounded-full px-8 py-4 font-bold inline-flex items-center gap-2 border-2 border-gray-200 text-gray-700 hover:border-costa-green hover:text-costa-green transition-all hover:-translate-y-1 bg-white">
                    OUR CAPABILITIES
                  </Link>
                </div>
              </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="lg:col-span-7 relative">
              ...
              <div className="absolute -bottom-8 -left-8 lg:bottom-12 lg:-left-12 bg-white/90 backdrop-blur-xl border border-gray-200 p-6 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.08)] w-[260px] animate-[slideUp_1s_ease-out_0.5s_both]">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    <div className="text-xs text-gray-400 font-bold tracking-widest uppercase">Verified</div>
                    <div className="font-heading font-black text-lg text-gray-900 leading-tight">ISO 9001</div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <ScrollReveal delay={0.1}>
              <div className="bg-white border border-gray-200 p-8 lg:p-10 rounded-3xl h-full shadow-sm hover:shadow-[0_20px_40px_rgba(26,175,93,0.1)] hover:border-costa-green/30 transition-all duration-500 flex flex-col group/card relative overflow-hidden">
                <div className="absolute inset-0 z-0 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity duration-700 mix-blend-multiply" style={{ backgroundImage: "url('/images/products/capacitors.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                ...
                <div className="relative z-10 flex-1 flex flex-col">
                  <h3 className="font-heading text-2xl font-bold mb-4 text-gray-900">Hard-to-Find Sourcing</h3>
                  ...
                  <Link href="/request-quote" className="relative z-10 mt-8 pt-6 border-t border-gray-100 flex items-center justify-between group/link cursor-pointer">
                    <span className="text-sm font-bold uppercase tracking-widest text-gray-900 group-hover/link:text-costa-green transition-colors">Explore Sourcing</span>
            ...
            <ScrollReveal delay={0.2}>
              <div className="bg-white border border-gray-200 p-8 lg:p-10 rounded-3xl h-full shadow-sm hover:shadow-[0_20px_40px_rgba(26,175,93,0.1)] hover:border-costa-green/30 transition-all duration-500 flex flex-col group/card relative overflow-hidden">
                <div className="absolute inset-0 z-0 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity duration-700 mix-blend-multiply" style={{ backgroundImage: "url('/images/products/circuit-protection.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                <div className="relative z-10 w-16 h-16 rounded-2xl bg-costa-green/10 flex items-center justify-center mb-8 text-costa-green shrink-0 group-hover/card:scale-110 transition-transform duration-500">
                  <Layers size={28} />
                </div>
                <div className="relative z-10 flex-1 flex flex-col">
                  <h3 className="font-heading text-2xl font-bold mb-4 text-gray-900">PCB Design Engineering</h3>
                  ...
                  <Link href="/contact" className="relative z-10 pt-6 border-t border-gray-100 flex items-center justify-between group/link cursor-pointer mt-auto">
                    <span className="text-sm font-bold uppercase tracking-widest text-gray-900 group-hover/link:text-costa-green transition-colors">View Capabilities</span>
                    <ArrowRight size={16} className="text-gray-400 group-hover/link:text-costa-green group-hover/link:translate-x-1 transition-all" />
                  </Link>
                </div>
              </div>
            ...
            <ScrollReveal delay={0.3}>
              <div className="bg-white border border-gray-200 p-8 lg:p-10 rounded-3xl h-full shadow-sm hover:shadow-[0_20px_40px_rgba(26,175,93,0.1)] hover:border-costa-green/30 transition-all duration-500 flex flex-col group/card relative overflow-hidden">
                <div className="absolute inset-0 z-0 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity duration-700 mix-blend-multiply" style={{ backgroundImage: "url('/images/products/transformers.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                <div className="relative z-10 w-16 h-16 rounded-2xl bg-costa-green/10 flex items-center justify-center mb-8 text-costa-green shrink-0 group-hover/card:scale-110 transition-transform duration-500">
                  <RefreshCcw size={28} />
                </div>
                <div className="relative z-10 flex-1 flex flex-col">
                  <h3 className="font-heading text-2xl font-bold mb-4 text-gray-900">Obsolete Parts Management</h3>
                  <p className="text-gray-500 font-medium leading-relaxed text-sm flex-1">
                  ...
                  <Link href="/request-quote" className="relative z-10 mt-8 pt-6 border-t border-gray-100 flex items-center justify-between group/link cursor-pointer">
                    <span className="text-sm font-bold uppercase tracking-widest text-gray-900 group-hover/link:text-costa-green transition-colors">Learn More</span>
                    <ArrowRight size={16} className="text-gray-400 group-hover/link:text-costa-green group-hover/link:translate-x-1 transition-all" />
                  </Link>
                </div>
              </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
           <ScrollReveal>
             <div className="text-center mb-16">
               ...
               <h3 className="font-heading text-3xl md:text-4xl font-black text-gray-900 tracking-tight">
      ...
      <section className="py-24 text-center px-6 bg-[#fafafa]">
        <ScrollReveal>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/request-quote" className="rounded-xl bg-gray-900 text-white hover:bg-costa-green transition-colors px-10 py-4 font-bold inline-flex items-center gap-2 shadow-xl shadow-gray-900/10 hover:-translate-y-1">
              Send BOM / RFQ <ArrowRight size={18} />
            </Link>
            <Link href="/contact" className="rounded-xl px-10 py-4 font-bold inline-flex items-center gap-2 border-2 border-gray-200 text-gray-700 hover:border-costa-green hover:text-costa-green bg-white transition-all hover:-translate-y-1">
